...
class FirebaseChatManager:
    ...
    def create_chat_session(self, user_id: str, chat_name: str) -> str:
        """
    ...
    def get_chat_details(self, user_id: str, chat_id: str) -> Optional[Dict]:
        """
        Get metadata about a specific chat session
